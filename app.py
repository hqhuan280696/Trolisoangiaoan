...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Quang Huấn - Trường Tiểu học Lăng Can - ĐT: 0987 730 891</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Quang Huấn - Trường Tiểu học Lăng Can - ĐT: 0997 730 891</div>", unsafe_allow_html=True)
